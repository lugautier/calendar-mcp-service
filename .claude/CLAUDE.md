...
## Development Workflow (7-Day Plan with SDK)

**Day 1** ✅ - Project setup, Maven build, health endpoint
**Day 2** - MCP SDK integration + McpServerConfig + get_events stub (hardcoded)
**Day 3** - MS Graph integration + OAuth2 + get_events with real data
**Day 4** - Implement block_dates tool
**Day 5** - Implement find_available_slots + reschedule_event
**Day 6** - Validation + error handling + E2E tests
**Day 7** - Tests + Docker + documentation + final validation
...
1. **Always check TODO.md** for detailed specifications before implementing
